...
pub mod prelude {
    ...
    pub use crate::analysis::{
        Dependence, DependenceKind, Direction, DependenceRelation,
        DependenceGraph, DependenceGraphSummary, DependenceAnalysis,
        SCoP, ScoPStmt, ScoPDetector,
        extract_scops, extract_polyhedral, analyze_dependencies,
        build_dependence_graph, is_parallelizable,
